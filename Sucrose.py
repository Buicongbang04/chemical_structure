...
#  Sucrose
sucrose_smiles = "OC1C(O)C(O)C(CO)OC1OC1(CO)OC(CO)C(O)C1(O)"

# Tạo cấu trúc sucrose
sucrose = Chem.MolFromSmiles(sucrose_smiles)
sucrose = Chem.AddHs(sucrose)  # Thêm các nguyên tử hydro
AllChem.EmbedMolecule(sucrose)
AllChem.UFFOptimizeMolecule(sucrose)

print("Hiển thị Sucrose:")
plotter_alpha = create_pyvista_molecule(sucrose)
plotter_alpha.show()